    ...
    fetch("http://localhost:5000/user/changepassword", {
      ...
      .then((response) => {
        if (response.status === 200) {
          ...
          alert(
            "This password is too short. Please choose a different password."
          );
          return false;
        } else {
          alert("Unauthorized.");
        ...
        <Stack direction="column" spacing={5}>
          ...
          <Stack direction="column" spacing={2}>
            ...
            <Stack direction="column" spacing={1}>
              ...
              <TextField type="password" onChange={updateNewPassword} />

              <h4 style={{ textAlign: "left" }}>Confirm New Password</h4>
              <TextField type="password" onChange={updateConfirmNewPassword} />
            </Stack>
